...
class MathPopup(tk.Toplevel):
    ...
    def __init__(self, parent, on_correct, on_wrong, sound10, sound11):
        ...
        # Title
        title_label = tk.Label(self, text="Solve This Math Problem!", font=("Arial", 16, "bold"))
...
class VirusPopup(tk.Toplevel):
    ...
    def __init__(self, parent, on_yes, on_no, sound8, virus_count=1):
        ...
        # Description
        desc_label = tk.Label(self, text="Click 'YES' to fix it or 'NO' to ignore.\n(Warning: Ignoring may cause problems!)", 
                              font=("Arial", 12))
